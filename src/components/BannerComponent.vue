...
<template>
  <header class="banner">
    <div class="apresentacao">
      <img src="../assets/images/logo.svg" alt="Loog do Cookin Up" />
      <p class="cabecalho-lg frase-cabecalho">
        <span class="texto-verde">Um baanquete de ideias para </span>
    ...
    <img src="../assets/images/foto-banner.png" class="foto-banner" alt="" />
  </header>
</template>
<style>
.banner {
